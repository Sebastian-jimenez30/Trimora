  ...
  const features = [
    {
      ...
      description:
        "El corazón de tu barbería. Organiza tus turnos sin esfuerzo, evitando empalmes y tiempos muertos. Diseñada específicamente para el flujo rápido y dinámico de los barberos con una visualización adaptativa.",
    ...
    },
    {
      ...
      description:
        "Conoce a tu clientela mejor que nunca. Crea perfiles personalizados con historiales de cortes, preferencias y un análisis financiero de los ingresos generados por cada cliente.",
    ...
    },
    {
      ...
      description:
        "Vende servicios y productos rápidamente. Tu inventario se conecta en tiempo real, bloqueando ventas si no hay stock y descontando automáticamente los productos usados durante un servicio.",
      ...
      <div className="container mx-auto max-w-[1200px] px-5">
        <div className="text-center mb-16">
          ...
          <p className="text-[#dcdcdc] font-light max-w-2xl mx-auto text-lg">
            Navega por los módulos principales y observa cómo se ve la herramienta diseñada para
            potenciar tu barbería.
          </p>
        </div>
              ...
              <ul className="space-y-4">
                {features[activeTab].details.map((detail, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    <svg
                      className="w-6 h-6 text-cognac flex-shrink-0 mt-0.5"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
