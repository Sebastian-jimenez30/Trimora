...
export default function ConfirmModal({
  ...
  return (
    <Dialog
      ...
      overlayClassName="z-[100] animate-in fade-in duration-200"
      className="bg-[#141414] border border-white/10 rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200"
    >
