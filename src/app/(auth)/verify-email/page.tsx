        ...
        {!isVerified ? (
          <>
            ...
            <p className="text-[#a0a0a0] mb-8 font-light leading-relaxed">
              Te hemos enviado un enlace de confirmación. Por favor, revisa tu bandeja de entrada o
              la carpeta de spam para verificar tu cuenta.
            </p>
          ...
          <>
            ...
            <div className="flex justify-center">
              <Link
                href="/dashboard"
                className="flex items-center gap-2 px-6 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full text-white transition-all text-sm font-medium"
              >
                Ir al Dashboard
                <svg
                  xmlns="http://www.w3.org/2000/svg"
