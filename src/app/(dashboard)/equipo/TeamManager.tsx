...
} from "@/modules/collaborators/actions";
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-white/5 text-sm text-sterling">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-pitch border border-white/10 flex items-center justify-center overflow-hidden shrink-0">
                        {member.avatarUrl ? (
                          ...
                          <span className="font-serif font-bold text-sterling">
                      ...
                      <div>
                        ...
                        {member.isCurrentUser && (
                          <span className="text-[10px] text-cognac font-bold">Tú</span>
                        )}
                      </div>
                    </div>
                  </td>
              ...
              {members.length === 0 && (
                <tr>
                  <td colSpan={4} className="p-8 text-center text-charcoal">
                    No hay miembros.
                  </td>
                </tr>
              )}
