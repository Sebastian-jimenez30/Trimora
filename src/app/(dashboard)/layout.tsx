    ...
    <div className="flex h-screen bg-pitch text-sterling font-sans overflow-hidden">
      ...
      <aside className="w-[260px] bg-gradient-to-b from-pitch to-[#111] border-r border-white/10 flex flex-col py-6 shrink-0">
        ...
        <ul className="list-none px-3 flex-1 flex flex-col gap-2">
          ...
          <li>
            <Link href="/agenda" className="flex items-center gap-3 px-4 py-3 text-charcoal hover:text-sterling hover:bg-white/5 rounded-lg text-sm font-medium transition-all">
              Agenda y Citas
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/inventario" className="flex items-center gap-3 px-4 py-3 text-charcoal hover:text-sterling hover:bg-white/5 rounded-lg text-sm font-medium transition-all">
              Inventario
            </Link>
          </li>
          <li>
