export default function AnalyticsLoading() {
  return (
    <div
      ...
      className="h-full overflow-y-auto bg-[#0f0f0f] p-4 md:p-7 animate-pulse"
    >
      ...
      <div className="grid grid-cols-2 xl:grid-cols-6 gap-3 mb-6">
        {Array.from({ length: 6 }).map((_, index) => (
          <div key={index} className="h-28 rounded-xl bg-white/5 border border-white/10" />
        ))}
      </div>
