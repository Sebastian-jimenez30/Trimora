...
export default function AnalyticsError({
  ...
  return (
    <div role="alert" className="h-full bg-[#0f0f0f] flex items-center justify-center p-6">
      <div className="max-w-md w-full rounded-xl border border-red-500/20 bg-[#141414] p-7 text-center">
        ...
        <p className="text-sm text-charcoal mt-2">
          La información del negocio sigue intacta. Intenta consultar nuevamente.
        </p>
        <button
          onClick={reset}
          className="mt-5 bg-cognac hover:brightness-110 text-white px-5 py-2.5 rounded-lg text-sm font-semibold"
        >
          Reintentar
        </button>
      </div>
