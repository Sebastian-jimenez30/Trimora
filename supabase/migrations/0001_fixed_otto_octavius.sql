...
ALTER TABLE "appointments" ADD COLUMN "staff_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "appointments" ADD COLUMN "service_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "appointments" ADD COLUMN "start_time" timestamp with time zone NOT NULL;--> statement-breakpoint
...
ALTER TABLE "clients" ADD COLUMN "total_spent" numeric(10, 2) DEFAULT '0';--> statement-breakpoint
ALTER TABLE "clients" ADD COLUMN "last_visit" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "organization_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "client_id" uuid;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "staff_id" uuid;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "total_amount" numeric(10, 2) NOT NULL;--> statement-breakpoint
...
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_staff_id_organization_members_id_fk" FOREIGN KEY ("staff_id") REFERENCES "public"."organization_members"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "appointments" DROP COLUMN "user_id";--> statement-breakpoint
ALTER TABLE "appointments" DROP COLUMN "service_name";--> statement-breakpoint
ALTER TABLE "appointments" DROP COLUMN "scheduled_at";--> statement-breakpoint
